...
{
    public class AssertRangesTestes
    {
        [Theory]
        [InlineData(700)]
        [InlineData(1500)]
        ...
        [InlineData(8000)]
        [InlineData(15000)]
        public void Funcionario_Salario_FaixasSalariasDevemRespeitarNivelProfissional(double salario)
        {
            // Arrange & Act
            var funcionario = new Funcionario("Philipe", salario);
